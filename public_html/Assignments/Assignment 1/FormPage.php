...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-8">
                <header class="h2, title">Character Creator</header>
            </div>
            <div class="col-sm-2"></div>
        </div>
        <div class="row">
                ...
                <form method="post" action="ResultPage.php">
                    <div class="form-group">
                        ...
                        <div id="Gender" class="form-check form-check-inline">
                            <input type="radio" value="Male" name="gender" class="form-check-input" id="genderM">
                            <lable for="genderM">Male</lable>
                            <input type="radio" value="Female" name="gender" class="form-check-input" id="genderF">
