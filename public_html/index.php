...
<head>
    ...
    <title>Christon's CSIS 2440 Homepage Test</title>
    <?php
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="#">CE 10</a>
                        <a class="dropdown-item" href="#">CE 11</a>
                        <a class="dropdown-item" href="#">CE 12</a>
                        <a class="dropdown-item" href="#">CE 13</a>
                        <a class="dropdown-item" href="#">CE 14</a>
                    </div>
                </li>
            </ul>
